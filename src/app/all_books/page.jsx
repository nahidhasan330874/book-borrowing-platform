...
export const metadata = {
  ...
  description: "Find your next read from our diverse collection of books. Filter by category, explore new arrivals, and borrow instantly—all in a smooth and user-friendly experience. ",
};
